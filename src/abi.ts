// This file is auto-generated by sync-abi.js — do not edit manually.
// Source: contracts/artifacts/src/*.sol/*.json
// Regenerate with `node sync-abi.js`. Verify with `node sync-abi.js --check`.
